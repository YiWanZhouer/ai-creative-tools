...
```
1. cp 方案骨架生成器.html → 版本归档/方案骨架生成器/v1/v1.3/方案骨架生成器.html
2. 修改根目录 方案骨架生成器.html → v1.4
3. git commit -m "chore: archive v1.3, bump to v1.4"
```
...
3. 重写根目录 方案骨架生成器.html → v2.0
4. git commit -m "feat: v2.0 major release, archive v1.x series"
```
...
| 工具 | 版本 | 归档位置（未归档） |
|------|:---:|------|
| 方案骨架生成器 | **v1.5** | `版本归档/方案骨架生成器/v1/v1.5/` |
| 创意方案生成器 | **v2.3** | 开发中，尚未归档 |

### 已归档版本

| 工具 | 版本 | 日期 | 备注 |
|------|:---:|------|------|
| 方案骨架生成器 | [v1.0](版本归档/方案骨架生成器/v1/v1.0/) | 2026-06-11 | 初版 |
| 方案骨架生成器 | [v1.3](版本归档/方案骨架生成器/v1/v1.3/) | 2026-06-15 | server mode + 页面重构 |
| 方案骨架生成器 | [v1.4](版本归档/方案骨架生成器/v1/v1.4/) | 2026-06-17 | API 超时 30s→120s 修复前版本 |
| 创意方案生成器 | [v1.0](版本归档/创意方案生成器/v1/v1.0/) | 2026-06-11 | 初版 |
